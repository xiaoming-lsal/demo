...
public class CompileAndRunJavaFile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            classStr = code.substring(code.indexOf("public class"), code.indexOf("{"));//获取类名字符串
            ...
            e.printStackTrace();
            req.setAttribute("msg", "格式不符合规范，请检查类名是否正确(如：public class YourClassName{}).错误信息:" + e.getMessage());
        }
